...
- P43F records the framework decision as `pilot`. Real framework adapters remain future work until dependency approval, trace/persistence redaction proof, and the same P42 schema/inventory/static-quality gates pass.
...
- `prompt:ai_java_mybatis_draft_pack@0.1.0`
