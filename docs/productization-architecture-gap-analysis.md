...
| Workflow lifecycle | `fixture-first` | Default workflow reaches `VALIDATION_COMPLETE` at `VALIDATE`; approval decisions are not part of the API/UI flow. | Must keep publish prevention and audit evidence while avoiding production-ready claims. |
