...
10. Keep optional P23 live quality gate evidence separate from default fixture-first scoring, then plan P24 document/code generation draft-only in its own wave.
